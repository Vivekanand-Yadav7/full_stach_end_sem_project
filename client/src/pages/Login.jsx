...
import { Package, Mail, Lock, Store, User, Loader2 } from 'lucide-react';
    ...
    <div className="min-h-screen bg-gradient-main flex items-center justify-center p-4">
      ...
      >
        ...
        <div className="flex gap-3 mb-6">
          <div className="flex-1 flex items-center gap-2 p-3 bg-primary/5 rounded-2xl border border-primary/10">
            <Store size={16} className="text-primary" />
            <div>
              <p className="text-xs font-bold text-primary">Retailer</p>
              <p className="text-[10px] text-slate-400">Manage inventory</p>
            </div>
          </div>
          <div className="flex-1 flex items-center gap-2 p-3 bg-blue-50 rounded-2xl border border-blue-100">
            <User size={16} className="text-blue-500" />
            <div>
              <p className="text-xs font-bold text-blue-500">Customer</p>
              <p className="text-[10px] text-slate-400">Browse & order</p>
            </div>
          </div>
        </div>
